function changeSrc() {
    ...
    videoHandles.forEach(function(handle) {
        ...
        handle.addEventListener('click', function() {
            videoFrame.src = 'https://www.youtube.com/embed/' + handle.dataset.src;
    
            videoHandles.forEach(function(row) {
...
function filtervideos() {
	...
	handles.forEach(function(handle) {
		...
		handle.addEventListener('click', function() {
			...
			document.getElementById('lpDesc').scrollIntoView({
				behavior: 'smooth'
			});
			...
			videoCards.forEach(function(videoCard) {
				...
				var videoCardKeyword = videoCard.getAttribute('data-keywords');

				if (videoCardKeyword.includes(handleKeyword) == false) {
